jQuery(document).ready(function ($) {
    ...
    // Reset Username Changer submit button
    var $aucBtn = $('#ocasio-auc-submit-btn');
    if ($aucBtn.length && $aucBtn.hasClass('ko-btn-saved')) {
        setTimeout(function () {
            $aucBtn.removeClass('ko-btn-saved').text('Update Username');
